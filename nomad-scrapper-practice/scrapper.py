...
def extract_job(html) :
  ...
  company_row = html.find("h3", {"class" : "fs-body1"}).find_all("span", recursive = False)
  ...
  return {
    "title" : title, "company" : company, "location" : location, "link" : f"https://stackoverflow.com/jobs/{job_id}"}
